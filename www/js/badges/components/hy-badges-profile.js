/**
 * Badge Profile
 * @description this components will show the users badge profile
 * @author Kanchana Yapa
 * @since 08/02/16
 */
angular.module('hyper.badges').directive('hyBadgesProfile', function() {
  return {
    restrict: 'E',
    replace: true,
    templateUrl: 'views/badges/components/hy-badges-profile.html',
