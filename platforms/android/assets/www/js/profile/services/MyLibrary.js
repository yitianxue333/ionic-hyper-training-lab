 ...
 * @since 22/09/16
 */
angular.module('hyper.profile').factory('MyLibrary', function($resource, Config, _) {

    /**
     * Creating resource instance
     */
    var resource = $resource(Config.API_TRAINING_URL + '/:op', {}, {
        getModuleList: { method: 'GET', params:{ op: 'user/training/module/licensed' } }
    });

    function get() {
        return resource.getModuleList().$promise;
    }
    ...
    function processSingleModule(moduleData, taxonomyStore, trainersStore) {
        ...
        const module = {
            ...
            purchasedOn: moduleData.purchased_on
        };
